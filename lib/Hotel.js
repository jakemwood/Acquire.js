...
module.exports = function(name) {
	...
	// [public] getSharePrice: (nothing) -> Int
	// Return the current price of a share
	this.getSharePrice = function() {
		return this.getStock()[0].currentValue();
	}
	
	// [public] sharesAvailable: (nothing) -> shareCount
	// returns the number of shares available
	this.sharesAvailable = function() {
		return (Constants.SHARES_MAX - stock.length);
	}
